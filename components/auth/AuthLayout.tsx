    ...
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden px-4 py-12 bg-[#F8FAFC]">
      ...
      <div className="relative w-full max-w-110">
        ...
        <div className="relative bg-white/80 backdrop-blur-2xl border border-white/50 rounded-3xl shadow-[0_20px_50px_rgba(79,70,229,0.05)] px-8 py-10 md:px-10">
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-1 rounded-b-full bg-linear-to-r from-indigo-500 to-purple-500 shadow-sm shadow-indigo-200" />

      
          <div className="flex items-center gap-3 mb-10">
            <div className="w-10 h-10 rounded-xl bg-linear-to-br from-indigo-600 to-indigo-700 flex items-center justify-center shadow-lg shadow-indigo-200 text-white text-sm font-bold font-mono">
              {">_"}
            </div>
